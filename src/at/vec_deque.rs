...
impl<'a, T> At<D1, &'a T> for &'a VecDeque<T> {
...
impl<T: Copy> At<D1, T> for VecDeque<T> {
...
impl<'a, T, C1> At<D2, &'a T> for &'a VecDeque<C1>
where
    &'a C1: At<D1, &'a T>,
{
...
impl<T, C1> At<D2, T> for VecDeque<C1>
where
    C1: At<D1, T>,
    for<'a> &'a C1: At<D1, T>,
{
...
impl<'a, T, C1> At<D3, &'a T> for &'a VecDeque<C1>
where
    &'a C1: At<D2, &'a T>,
{
...
impl<T, C1> At<D3, T> for VecDeque<C1>
where
    C1: At<D2, T>,
    for<'a> &'a C1: At<D2, T>,
{
